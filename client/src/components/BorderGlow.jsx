...
const BorderGlow = ({
  ...
  const hoverBorderOpacity = isVisible
    ? Math.max(0, (edgeProximity * 100 - colorSensitivity) / (100 - colorSensitivity))
    : 0
  const hoverGlowOpacity = isVisible
    ? Math.max(0, (edgeProximity * 100 - edgeSensitivity) / (100 - edgeSensitivity))
    : 0
  const borderOpacity = Math.max(idleBorderOpacity, hoverBorderOpacity)
  const glowOpacity = Math.max(idleGlowOpacity, hoverGlowOpacity)
